...
class BasicsTest extends (ParserBaseTest) {
	...
	test_auto_cast() {
		...
		assert_result_is("int i='3'", 3)
		assert_result_is("string j=3", '3')
	}

	test_cast() {
		assert_result_is("i=3.2 as int", 3)
		assert_result_is("i='3' as int", 3)
		assert_result_is("j=3 as string", '3')
	}

	test_cast2() {
		assert_result_is("i=int(3.2)", 3)
		assert_result_is("i=int('3')", 3)
		assert_result_is("j=string(3)", '3')
	}
...
// module.exports.test_current=new BasicsTest().
// test_cast2
// 	test_auto_cast
